...
@ex.config
def config():
    data_folder = '/home/kiapi/Documents/MRCNet/data/'
    #test_sequence = ['01','02']
    test_sequence = ['00']
    ...
    out_fig_lg = 'EN' # [EN, CN]
#weights = ['/home/kiapi/Documents/MRCNet/ourdata/val_seq_11_12_13_14_15_16_17_18_19_20_21/models/checkpoint_r20.00_t1.50_e40_0.119.tar']
weights = ['/home/kiapi/Documents/MRCNet/ourdata/val_seq_00/models/checkpoint_r20.00_t1.50_e85_0.041.tar']
...
# weights_P = ['/home/kiapi/Documents/MRCNet/ourdata/val_seq_01_02/models/checkpoint_r1.00_t0.10_e113_0.001.tar',
# weights = ['/home/kiapi/Documents/MRCNet/ourdata/val_seq_01_02/models/checkpoint_r20.00_t1.50_e116_0.077.tar',

#print(weights_P[0])

# #weights_L = ['/home/kiapi/Documents/MRCNet/ourdata/val_seq_01_02/models/checkpoint_r1.00_t0.10_e109_0.001.tar',
#              '/home/kiapi/Documents/MRCNet/2-0.2.tar',
#              '/home/kiapi/Documents/MRCNet/ourdata/val_seq_01_02/models/checkpoint_r1.00_t0.10_e6_0.001.tar'
# ]
...
def main(_config, seed):
    ...
    for i in range(len(weights)):
        ...
        if i<6:
            ...
            rgb = torch.randn(1, 3, 256, 1024).cuda()
            lidar = torch.randn(1, 1, 256, 1024).cuda()

            # FLOPs, 파라미터 계산
            flops, params = profile(model, inputs=(rgb, lidar))
            ...
            print(f"Model {i+1}: Total Parameters = {num_params/1e6:.3f}M, Trainable = {trainable_params/1e6:.3f}M")
            models.append(model)
    ...
    for batch_idx, sample in enumerate(tqdm(TestImgLoader)):
        ...
        rgb_resize = F.interpolate(rgb_input, size=[256, 1024], mode="bilinear")
        lidar_resize = F.interpolate(lidar_input, size=[256, 1024], mode="bilinear")
        ...
        with torch.no_grad():
            for iteration in range(start, len(weights)):
                ...
                lidar_resize = F.interpolate(lidar, size=[256, 1024], mode="bilinear")
    ...
    print(f"Average FPS (frames per second): {fps:.2f}\n")
