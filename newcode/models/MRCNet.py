...
class MRCNet(nn.Module):
    ...
    def __init__(self, image_size, use_feat_from=1, md=4, use_reflectance=False, dropout=0.0,
        ...
        self.toplayer_jy = nn.Conv2d(512, 64, 1, 1, 0)
    ...
    dilation_patch=1)
        ...
        self.fc1_trasl_jy = nn.Linear(67936, 64)   # 256 512  
        self.fc1_rot_jy = nn.Linear(67936, 64)        
        self.fc115_trasl_jy=nn.Linear(4096, 128)              
        self.fc114_trasl_jy=nn.Linear(8192, 64)        
        self.fc113_trasl_jy=nn.Linear(16384, 32)
    ...
    def forward(self, rgb, lidar):
        ...
        p15 = self.toplayer_jy_img(c16)
        p14 = self._upsample_add(p15, self.latlayer1_jy_img(c15))
        p13 = self._upsample_add(p14, self.latlayer2_jy_img(c14))
